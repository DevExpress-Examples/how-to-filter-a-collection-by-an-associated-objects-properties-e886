...
Namespace AssociatedCollectionFilter
	...
	Public Class Form1
		...
		Private WithEvents btnFiterStandard As DevExpress.XtraEditors.SimpleButton
		''' <summary>
		...
		Private Sub InitializeComponent()
			...
			Me.btnFiterStandard = New DevExpress.XtraEditors.SimpleButton()
			...
			' xpCollection1
			' 
			Me.xpCollection1.ObjectType = GetType(AssociatedCollectionFilter.Customer)
			...
			Me.panelControl1.Controls.Add(Me.btnFiterStandard)
...
'			Me.btnFiterSimplified.Click += New System.EventHandler(Me.btnFiterSimplified_Click);
			' 
			' btnClear
			' 
...
'			Me.btnClear.Click += New System.EventHandler(Me.btnClear_Click);
			...
			' btnFiterStandard
			' 
			Me.btnFiterStandard.Location = New System.Drawing.Point(8, 8)
			Me.btnFiterStandard.Name = "btnFiterStandard"
			Me.btnFiterStandard.Size = New System.Drawing.Size(192, 23)
			Me.btnFiterStandard.TabIndex = 0
			Me.btnFiterStandard.Text = "Apply Filter (new ContainsOperator)"
'			Me.btnFiterStandard.Click += New System.EventHandler(Me.btnFiterStandard_Click);
			' 
			' Form1
			' 
...
'			Me.Load += New System.EventHandler(Me.Form1_Load);
		...
		Private Sub btnFiterStandard_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFiterStandard.Click
			Dim criteria As CriteriaOperator = New ContainsOperator("Orders", New BinaryOperator("Employee.LastName", "Buchanan"))
			SetFilter(criteria)
		End Sub

		Private Sub btnFiterSimplified_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFiterSimplified.Click
            Dim criteria As CriteriaOperator = New OperandProperty("Orders").Item(New OperandProperty("Employee.LastName") = "Buchanan")
			SetFilter(criteria)
		End Sub
